...
const studentProfile = {
  studentName : "HEMANTH M",
  studentAge : 19,
  cohortName : "BCA(Hons)",
  location : "Bengaluru",
  hobbies : ["listening to music", "Gaming", "Traveling"]
}

studentProfile.hobbies.push("Reading")
...
const bookpro = new Book("What Matters Most in Life", "DR Sajith Cyriac")
